          ...
          <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            <button
              ...
              className={cn(
                ...
                currentPage === 1 ? 'bg-gray-50' : 'bg-white hover:bg-gray-50'
              )}
            >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      page === currentPage
                        ...
                        : 'text-gray-900 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500'
                    )}
                  >
                    {page}
                  </button>
            ...
            <button
              ...
              className={cn(
                ...
                currentPage === totalPages ? 'bg-gray-50' : 'bg-white hover:bg-gray-50'
              )}
            >
